...
// Also test what the actual indexing looks like
console.log('\nActual search scoring for "链式":');
const results = fuse.search('链式');
results.forEach(r => console.log('  -', r.item.title, '(score:', r.score, ')'));
