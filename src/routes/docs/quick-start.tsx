...
function QuickStartPage() {
  ...
  const steps = [
    t("quickStart.steps.deployMaster"),
    t("quickStart.steps.addServer"),
    t("quickStart.steps.installXray"),
    t("quickStart.steps.createInbound"),
    t("quickStart.steps.syncNodes"),
    t("quickStart.steps.generateSub"),
  ];
...
# 安装完成后访问 http://服务器IP:12889 进入初始化向导`}</pre>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              安装脚本已负责数据库初始化：SQLite 不安装额外服务；选择 PostgreSQL
              会安装 PostgreSQL 18、创建账号并自动写入连接配置。Docker 模式使用
              Compose，数据持久化到安装目录。
            </p>
            <p className="text-sm text-muted-foreground">
              {t("quickStart.step1.moreInstall")}{" "}
              <Link
        ...
        <Card>
          <CardContent className="pt-6">
            <ol className="space-y-3 text-sm">
              ...
              <li>
                4. {t("quickStart.step2.item4pre")}{" "}
                <Link
                  to="/docs/install-agent"
                  className="text-primary hover:underline"
                >
                  {t("quickStart.step2.agentDeploy")}
                </Link>
                {t("quickStart.step2.item4post")}
              </li>
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground mb-3">
              {t("quickStart.step3.text1")}
            </p>
            <p className="text-sm text-muted-foreground">
              {t("quickStart.step3.text2")}
            </p>
          </CardContent>
        </Card>
      </section>
        ...
        <Card>
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-muted-foreground mt-3">
              {t("quickStart.step4.protocolRef")}{" "}
              <Link
                to="/docs/protocol-matrix"
                className="text-primary hover:underline"
              >
                {t("quickStart.step4.protocolMatrix")}
              </Link>
            </p>
          </CardContent>
        </Card>
      ...
      <section id="step-5" className="mb-10">
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground mb-3">
              {t("quickStart.step5.text1")}
            </p>
            <p className="text-sm text-muted-foreground">
              {t("quickStart.step5.text2")}
            </p>
          </CardContent>
        </Card>
      </section>
      ...
      <section id="step-6" className="mb-10">
        ...
        <Card>
          <CardContent className="pt-6">
            <p className="text-muted-foreground mb-3">
              {t("quickStart.step6.text1")}
            </p>
            <p className="text-sm text-muted-foreground">
              {t("quickStart.step6.text2")}{" "}
              <Link
                to="/docs/generator"
                className="text-primary hover:underline"
              >
                {t("quickStart.step6.generateSub")}
              </Link>
            </p>
          </CardContent>
        </Card>
