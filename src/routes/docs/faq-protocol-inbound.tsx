...
export const Route = createFileRoute('/docs/faq-protocol-inbound')({
  component: Page,
})
...
function Page() {
  ...
  return (
    <XDocLayout title={t('faq.protocolInbound.heading')} description={t('faq.protocolInbound.description')}>
