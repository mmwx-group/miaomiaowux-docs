    ...
    └────────┘ └────────┘ └────────┘`}</pre>
      ...
      <section>
        ...
        <div className='flex gap-4'>
          <Link to='/docs/features' className='text-primary hover:underline'>{t('about.nextSteps.viewFeatures')}</Link>
          <Link to='/docs/quick-start' className='text-primary hover:underline'>{t('about.nextSteps.quickStart')}</Link>
        </div>
      </section>
    </XDocLayout>
  )
