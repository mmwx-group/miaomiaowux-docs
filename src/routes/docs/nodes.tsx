  ...
  return (
    <XDocLayout title={t('nodes.title')} description={t('nodes.description')}>
      ...
      <section className='mb-10'>
        ...
        {/* 添加 Tunnel */}
        <h3 className='text-lg font-semibold mb-3'>{t('nodes.tunnelAddHeading')}</h3>
        <p className='text-sm text-muted-foreground mb-3'>{t('nodes.tunnelAddText')}</p>
        <div className='space-y-4 mb-8'>
          ...
          <Card>
            <CardContent className='pt-6'>
              <h3 className='font-semibold mb-2'>{t('nodes.tunnelPortForwardHeading')}</h3>
              <p className='text-sm text-muted-foreground'>{t('nodes.tunnelPortForwardText')}</p>
            </CardContent>
          </Card>
        </div>

        {/* 端口转发复用模式 */}
        <h3 className='text-lg font-semibold mb-3'>{t('nodes.tunnelReuseHeading')}</h3>
        <Card className='mb-8'>
        ...
        {/* 切换服务器地址(中转) */}
        <h3 className='text-lg font-semibold mb-3'>{t('nodes.tunnelSwitchHeading')}</h3>
        <Card className='mb-8'>
          <CardContent className='pt-6 space-y-2 text-sm text-muted-foreground'>
