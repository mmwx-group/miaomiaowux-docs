...
const xNavStructure: XNavItemDef[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'install-agent', href: '/docs/install-agent', icon: Radio, badgeKey: 'new' },
      { id: 'upgrade-from-mmw', href: '/docs/upgrade-from-mmw', icon: ArrowRightLeft, badgeKey: 'new' },
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'xray-routing', href: '/docs/xray-routing', icon: Route, badgeKey: 'new' },
      { id: 'xray-system-config', href: '/docs/xray-system-config', icon: Settings },
    ],
  },
  {
    id: 'protocol-ref',
    ...
    children: [
      ...
      { id: 'protocol-shadowsocks', href: '/docs/protocol-shadowsocks', icon: Lock },
      { id: 'protocol-hysteria2', href: '/docs/protocol-hysteria2', icon: Lock },
      { id: 'protocol-anytls', href: '/docs/protocol-anytls', icon: Lock, badgeKey: 'new' },
      { id: 'protocol-snell', href: '/docs/protocol-snell', icon: Lock, badgeKey: 'new' },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: Workflow,
    children: [
      { id: 'routed-outbound', href: '/docs/routed-outbound', icon: ArrowRightLeft, badgeKey: 'new' },
      { id: 'system-settings-guide', href: '/docs/system-settings', icon: Settings },
    ],
  },
  {
    id: 'pro-features',
    ...
    badgeKey: 'pro',
    children: [
      { id: 'node-speedtest', href: '/docs/node-speedtest', icon: Gauge, badgeKey: 'pro' },
      { id: 'node-ratelimit', href: '/docs/node-ratelimit', icon: Ban, badgeKey: 'pro' },
      { id: 'share-server', href: '/docs/share-server', icon: Share2, badgeKey: 'pro' },
      { id: 'embedded-xray', href: '/docs/embedded-xray', icon: Box, badgeKey: 'pro' },
    ],
  },
  {
    id: 'certificates',
  ...
  },
  {
    ...
    icon: Bot,
    children: [
      { id: 'mcp', href: '/docs/mcp', icon: Bot, badgeKey: 'new' },
    ],
  },
  {
    id: 'tools',
    icon: Hammer,
    children: [
      { id: 'tool-mmwx-tgbot', href: '/docs/tool-mmwx-tgbot', icon: Bot, badgeKey: 'new' },
      { id: 'tool-cloudflare-turnstile', href: '/docs/tool-cloudflare-turnstile', icon: ShieldCheck, badgeKey: 'new' },
    ],
  },
  {
    id: 'faq',
    ...
    children: [
      ...
      { id: 'faq-node-management',     href: '/docs/faq-node-management',     icon: HelpCircle },
      { id: 'faq-install-deploy',      href: '/docs/faq-install-deploy',      icon: HelpCircle },
      { id: 'faq-common-ops',          href: '/docs/faq-common-ops',          icon: HelpCircle },
      { id: 'faq-server-management',   href: '/docs/faq-server-management',   icon: HelpCircle },
      { id: 'faq-protocol-inbound',    href: '/docs/faq-protocol-inbound',    icon: HelpCircle },
