...
import { DocDemo } from "@/components/docs/islands/speedtest";
...
The real workbench in the master: choose the source (master / home endpoint), threads and packet size at the top; one node per row with speed test, latency test and exit IP
