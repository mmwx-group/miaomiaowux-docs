...
import { DocDemo } from "@/components/docs/islands/migration";
...
![Avatar menu screenshot](../../../assets/screenshots/user-menu.webp)

Avatar menu: the "Migrate from MiaoMiaoWu" entry is only visible to admins

![Migration wizard page screenshot](../../../assets/screenshots/migrate-from-mmw.webp)

Step 1 of the real migration wizard: guarantees and prerequisites
