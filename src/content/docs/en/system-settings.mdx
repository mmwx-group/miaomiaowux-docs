...
import { DocDemo } from "@/components/docs/islands/system-settings";

![System Settings "Features" tab screenshot](../../../assets/screenshots/settings-features.webp)

System Settings — 13 tabs at the top (Subscription / Features / Users / Notifications / Security / Probe / Appearance / Announcements / TG Bot / Captcha / System / Database / License); shown here: "Features"
...
| Appearance    | Set the default theme, login wallpaper, custom branding, and [custom CSS](/docs/en/custom-css). A user's theme takes priority; custom branding and custom CSS require the matching PRO feature. | Effective after saving        |
...
Screenshots and purpose of every tab in order; key settings are explained in detail further down.

![Subscription tab screenshot](../../../assets/screenshots/settings-subscription.webp)

Subscription: external subscription sync (traffic info, node-name filter / append), external node probe, auto re-sync when nodes go offline

![Users tab screenshot](../../../assets/screenshots/settings-users.webp)

Users: MiaoMiaoWu features (probe / generator menus), user menu items, user quotas (e.g. allow users to create routed outbounds, count and daily limit), user-created child nodes

![Notifications tab screenshot](../../../assets/screenshots/settings-notify.webp)

Notifications: enable push, Telegram Bot Token / Chat ID, per-event switches, daily message text

![Security tab screenshot](../../../assets/screenshots/settings-security.webp)

Security: login rate limit, brute-force protection, subscription request frequency and other thresholds, auto-saved on blur

![Probe tab screenshot](../../../assets/screenshots/settings-probe.webp)

Probe: disguise the site as a public monitor page, configure title / logo / hidden login / shown servers and collected metrics, API fields in [Probe API](/docs/en/probe-api)

![Appearance tab screenshot](../../../assets/screenshots/settings-appearance.webp)

Appearance: custom branding (PRO), panel wallpaper, menu order, custom CSS, default theme, login wallpaper and login box opacity

![Announcements tab screenshot](../../../assets/screenshots/settings-announcement.webp)

Announcements: templates for node blocked / recovered / maintenance / subscription update, choose Bot / Mini App channels and publish

![TG Bot tab screenshot](../../../assets/screenshots/settings-tgbot.webp)

TG Bot: enable the built-in Bot and Mini App, Bot Token, admin Telegram IDs, redeem-code copy text, see [Telegram Bot](/docs/en/tool-mmwx-tgbot)

![Captcha tab screenshot](../../../assets/screenshots/settings-captcha.webp)

Captcha: Cloudflare Turnstile Site Key / Secret Key, see [Cloudflare Turnstile](/docs/en/tool-cloudflare-turnstile)

![System tab screenshot](../../../assets/screenshots/settings-system.webp)

System: auto backup, custom proxy-group source, scheduler intervals, master address / subscription domain, disable public access, HTTPS self-healing, API Token

![Database tab screenshot](../../../assets/screenshots/settings-database.webp)

Database: view the current database type and migrate between SQLite and PostgreSQL, see [Backup & Restore](/docs/en/backup-restore)

![License tab screenshot](../../../assets/screenshots/settings-license.webp)

License: after saving the license key it shows the plan, quotas (servers / nodes / users) and unlocked PRO features, plus where the license title is displayed
...
<table class="w-full text-sm">
  <tbody>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium w-28">Type</td>
      <td class="py-2">Toggle</td>
    </tr>
    <tr class="border-b">
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, traffic info page data includes external subscription
        traffic. The system reads the subscription-userinfo response header when
        fetching subscriptions and merges traffic data into total statistics.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, remaining traffic and days are appended to node names
        during external subscription sync. Example: NodeName 398.22GB 26Days.
        Convenient for users to view subscription traffic and validity directly
        in clients.
      </td>
    </tr>
  </tbody>
...
<table class="w-full text-sm">
  <tbody>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium w-28">Type</td>
      <td class="py-2">Text input (regex)</td>
    </tr>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium">Default</td>
      <td class="py-2">
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        Uses regex to match node names. Matched nodes are filtered out during
        sync. Commonly used to filter traffic info nodes, announcement nodes,
        and other non-proxy nodes from airport subscriptions. Leave empty for no
        filtering.
      </td>
    </tr>
  </tbody>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, the system re-fetches the latest nodes from external
        subscription links every time a user gets a subscription, updating the
        database. When disabled, only uses nodes already saved in the database.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium w-28">Default</td>
      <td class="py-2">On</td>
    </tr>
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, preserves database node names during sync instead of using
        external subscription names. Suitable when node names have been manually
        modified.
      </td>
    </tr>
  </tbody>
...
<table class="w-full text-sm">
  <tbody>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium w-28">Default</td>
      <td class="py-2">0 (re-fetch every time)</td>
    </tr>
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        Set to 0 to re-fetch external subscription on every subscription
        request. When &gt; 0, only re-fetches if the set minutes have passed
        since last fetch. Recommended 30-60 minutes to balance freshness and
        response speed.
      </td>
    </tr>
  </tbody>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, MiaoMiaoWu X returns 404 pages for all requests, hiding
        the panel's existence. When a user fetches a subscription via
        subscription link, the server resumes normal access for a duration set
        by Recovery Duration. After timeout, it re-enters silent mode.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium">Range</td>
      <td class="py-2">1 - 1440 minutes</td>
    </tr>
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        Duration of normal access after a user fetches a subscription. After
        timeout, re-enters 404 silent mode.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, the subscription link page shows an additional 6-character
        short link. Short links are easier to share and type. Users can reset
        short links in personal settings.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, subscription generation auto-filters node types
        unsupported by the target client (e.g., WireGuard nodes unsupported by
        Clash), only logging instead of erroring. When disabled, incompatible
        nodes produce error messages.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, the override management page shows script functionality.
        Use JavaScript scripts to modify subscription configs, such as changing
        node properties, adding custom fields, adjusting proxy group structure,
        etc. For users with advanced customization needs.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, each node in the node management list shows a probe
        binding button, allowing nodes to be bound to specific probe servers.
        Once bound, traffic statistics only aggregate probe data for that node,
        enabling more precise traffic attribution.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        Proxy Provider allows dynamically loading nodes from external
        subscriptions. When enabled, proxy providers can be configured on the
        subscription files page and dragged into proxy groups during editing.
        Suitable for mixed use of local and external airport nodes.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium w-28">Type</td>
      <td class="py-2">Radio</td>
    </tr>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium">Default</td>
      <td class="py-2">v2 (Universal Backend)</td>
    </tr>
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        Select the template engine version used for subscription generation.
        Different versions have different template syntax and capabilities.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, the system reads probe and external subscription traffic
        data during subscription fetch and writes subscription-userinfo info to
        HTTP response headers. Clients (like Clash, Stash) display traffic usage
        and expiry accordingly. When disabled, skips traffic data reading and
        doesn't write response headers.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium">Default</td>
      <td class="py-2">YAML</td>
    </tr>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium">Options</td>
      <td class="py-2">
        <code class="bg-muted px-1.5 py-0.5 rounded text-xs">YAML</code> /{" "}
        <code class="bg-muted px-1.5 py-0.5 rounded text-xs">JSON</code>
      </td>
    </tr>
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        Select Clash subscription output format. Default YAML. When JSON is
        selected, Clash subscriptions output in JSON format. This setting only
        affects Clash format subscriptions, not other client formats (Surge,
        Sing-Box, Shadowrocket, etc.).
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, two info nodes are added at the top of the node list
        during subscription output, showing expiry time and remaining traffic.
        These are not real proxy nodes, only for displaying subscription info in
        client node lists.
      </td>
    </tr>
  </tbody>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Example Output</td>
      <td class="py-2">
        <code class="bg-muted px-1.5 py-0.5 rounded text-xs">
          Expiry: 2025-12-31
        </code>
...
<table class="w-full text-sm">
  <tbody>
    ...
    <tr>
      <td class="py-2 pr-4 font-medium">Description</td>
      <td class="py-2">
        When enabled, the system sends event notifications via Telegram Bot.
        First configure Bot Token and Chat ID by clicking the gear icon next to
        the notification push toggle.
      </td>
    </tr>
  </tbody>
</table>
...
<table class="w-full text-sm">
  <tbody>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium w-28">Description</td>
      <td class="py-2">
        Sync the latest preset proxy group config from a remote address. Proxy
        group config contains common rule categories and corresponding
        rule-providers settings. After sync, updates the rule selector and
        preset proxy groups on the subscription generation page.
      </td>
    </tr>
    <tr class="border-b">
      <td class="py-2 pr-4 font-medium">Remote Config Address</td>
      <td class="py-2">
        Customize the remote config URL. Leave empty to use system default or
        environment variable configured address.
      </td>
    </tr>
    <tr>
      <td class="py-2 pr-4 font-medium">Operation</td>
      <td class="py-2">
        Click Sync Proxy Group Config button to manually trigger sync. A
        confirmation prompt appears after successful sync.
      </td>
    </tr>
  </tbody>
</table>
