...
| Appearance    | Set the default theme, login wallpaper, custom branding, and [custom CSS](/en/custom-css/). A user's theme takes priority; custom branding and custom CSS require the matching PRO feature. | Effective after saving        |
