...
![在 MMWX Probe 项目说明顶部点击 Deploy to Cloudflare。](../../assets/screenshots/external-probe-deploy-button.svg)
...
![填写项目名称、MMWX_ORIGIN 与 PROBE_TOKEN 后点击“部署”。](../../assets/screenshots/external-probe-cloudflare-settings.svg)
...
![fork 落后时点击 Sync fork → Update branch；不要选择 Discard commits。](../../assets/screenshots/external-probe-sync-fork.svg)

fork 落后时点击 Sync fork → Update branch；不要选择 Discard commits。

![Actions 页面左侧会显示 Sync upstream；运行成功后会出现绿色状态标记。](../../assets/screenshots/external-probe-actions.png)
